...
CREATE TABLE `mouvement` (
  ...
  CONSTRAINT `mouvement_ibfk_1` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`)
...
INSERT INTO `mouvement` VALUES (1,1,2,'Entrée','2026-02-09 15:38:23'),(2,1,3,'Entrée','2026-02-09 15:39:07');
...
INSERT INTO `produit` VALUES (1,'ordinateur hp',150000.00,5,1);
...
-- Dump completed on 2026-02-10 10:48:12
